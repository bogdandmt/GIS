<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ThinkGeo.MapSuite.WmsServerEdition.Admin" %>
...
<body>
    ...
    <div style="width: 766px; margin: auto; text-align: left;">
        <table cellpadding="0" cellspacing="0" border="0" style="margin-top: 0px; vertical-align: top;
            width: 100%; height: 100%">
            <tr style="height: 10px; background-color: #2c4056">
                <td colspan="2">
                </td>
            </tr>
            <tr style="height: 50px; width: 100%; background-image: url(Images/header_bkg.jpg);
                background-repeat: no-repeat; background-color: #5179ac">
            ...
            <tr>
                <td style="background-color: Transparent" valign="top" colspan="2">
                    <div style="border: solid 1px #e4e4e4; padding: 20px">
                        <div>
                            <a href="WmsHandler.axd?SERVICE=WMS&VERSION=1.1.1&REQUEST=GetCapabilities" target="_blank">
                                View Capabilities</a>
                            <asp:Label runat="server" ID="ExceptionMessage" ForeColor="Red"></asp:Label>
                        </div>
                        <asp:Repeater runat="server" ID="PluginsRepeater" OnItemDataBound="PluginsRepeater_ItemDataBound">
                            <ItemTemplate>
                                <table border="0">
                                    <tr>
                                        <td align="center">
                                            <img runat="server" id="PreviewImage" alt="Preview" class="preview"
                                                visible="false" />
                                        </td>
                                        <td valign="top">
                                            <div>
                                                ...
                                                <asp:GridView ID="PluginGridView" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="Supported Style" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Center">
                                                        </asp:BoundField>
                                                        <asp:BoundField HeaderText="Supported Srs" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Center" />
                                                        <asp:BoundField DataField="FullName" ItemStyle-HorizontalAlign="Center" />
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <a runat="server" id="PreviewLink" href="#">Preview</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
    ...
    <script type="text/javascript">
        ...
        function OpenViewLayer(obj, href) {
            //window.showModalDialog(href, "", 'dialogHeight: 640px; dialogWidth: 480px;');
            window.open(href, "WmsSample", "width=640,height=480,directories=no,menubar=no,toolbar=no,scrollbars=no");
        }
